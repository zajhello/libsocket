...
#third_party.libwebsocket.include <winsock2.h>
#third_party.libwebsocket.include <ws2tcpip.h>
#third_party.libwebsocket.include <stddef.h>
#third_party.libwebsocket.include <basetsd.h>
#third_party.libwebsocket.include <io.h>
#ifndef _WIN32_WCE
#third_party.libwebsocket.include <fcntl.h>
#else
...
#third_party.libwebsocket.include <sys/capability.h>
#endif

#if defined(__NetBSD__) || defined(__FreeBSD__) || defined(__QNX__)
#third_party.libwebsocket.include <netinet/in.h>
#endif
...
#third_party.libwebsocket.include <ev.h>
#endif /* LWS_WITH_LIBEV */
#ifdef LWS_WITH_LIBUV
#include <uv.h>
#ifdef LWS_HAVE_UV_VERSION_H
#third_party.libwebsocket.include <uv-version.h>
#endif
#endif /* LWS_WITH_LIBUV */
#if defined(LWS_WITH_LIBEVENT)
#third_party.libwebsocket.include <event2/event.h>
 ...
 */
#third_party.libwebsocket.include <IDE/WIN/user_settings.h>
#third_party.libwebsocket.include <cyassl/ctaocrypt/settings.h>
#else
#third_party.libwebsocket.include <cyassl/options.h>
#endif
#third_party.libwebsocket.include <cyassl/openssl/ssl.h>
#third_party.libwebsocket.include <cyassl/error-ssl.h>
 ...
 */
#third_party.libwebsocket.include <IDE/WIN/user_settings.h>
#third_party.libwebsocket.include <wolfssl/wolfcrypt/settings.h>
#else
#third_party.libwebsocket.include <wolfssl/options.h>
#endif
#third_party.libwebsocket.include <wolfssl/openssl/ssl.h>
#third_party.libwebsocket.include <wolfssl/error-ssl.h>
...
#endif
#third_party.libwebsocket.include <mbedtls/ssl.h>
#else
#third_party.libwebsocket.include <openssl/ssl.h>
#if !defined(LWS_WITH_MBEDTLS)
#third_party.libwebsocket.include <openssl/err.h>
#endif
#endif
...
#third_party.libwebsocket.include <pthread.h>
...
#third_party.libwebsocket.include <freertos/FreeRTOS.h>
#third_party.libwebsocket.include <freertos/event_groups.h>
#third_party.libwebsocket.include <string.h>
#third_party.libwebsocket.include "esp_wifi.h"
#third_party.libwebsocket.include "esp_system.h"
#third_party.libwebsocket.include "esp_event.h"
#third_party.libwebsocket.include "esp_event_loop.h"
#third_party.libwebsocket.include "nvs.h"
#third_party.libwebsocket.include "driver/gpio.h"
#third_party.libwebsocket.include "esp_spi_flash.h"
#third_party.libwebsocket.include "freertos/timers.h"
...
#third_party.libwebsocket.include <mdns.h>
#third_party.libwebsocket.include <esp_partition.h>
...
#third_party.libwebsocket.include <sys/types.h>
#third_party.libwebsocket.include <sys/stat.h>
#endif
...
enum lws_callback_reasons {
	 ...
	 *
	 * Diagnostic strings that may be returned third_party.libwebsocket.include
	 *
...
#if defined(LWS_WITH_MBEDTLS)
#third_party.libwebsocket.include <mbedtls/sha1.h>
#third_party.libwebsocket.include <mbedtls/sha256.h>
#third_party.libwebsocket.include <mbedtls/sha512.h>
#endif
 ...
 * \param nonce: Nonse string to third_party.libwebsocket.include in protected header
 ...
 *
 *  Notice that the header total length reported does not third_party.libwebsocket.include a terminating
 ...
 *		The returned length does not third_party.libwebsocket.include the space for a
 *		terminating '\0'
 *
 * \param wsi: websocket connection
 ...
 *		The buffer length len must third_party.libwebsocket.include space for an additional
